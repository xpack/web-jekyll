---
title:  xPack xpm v0.14.4 released
sidebar: xpm

summary: "Version **0.14.4** is a maintenance release; it fixes the download bug."

version: 0.14.4

date: 2023-01-23 20:05:00 +0200
...
application to orchestrate builds and to manage
...
- [#154] In certain conditions, downloading some archives silently failed; fixed
...
npm xpm@0.14.4 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
