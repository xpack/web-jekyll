---
title:  xPack xpm v0.13.0 released

summary: "Version **0.13.0** is a new release; it fixes several issues and adds support for inheritance in build configurations."

version: 0.13.0

date: 2022-04-17 20:02:00 +0300
...
- [#133] - fix changing file mode to R/O on Windows

### Enhancements

- [#136] - do not show stack trace if the configuration name is not present
- [#135] - add `--ignore-errors` to allow scripts using `run` & `install`
  to continue
- [#134] - implement buildConfiguration inheritance
- [#132] - improve error message for missing configuration
...
npm xpm@0.13.0 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
