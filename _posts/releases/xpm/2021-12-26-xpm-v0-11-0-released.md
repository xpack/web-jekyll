...
- [#122] the logic used by `xpm install` to install all dependencies included
  the dependencies for all build configurations, which was ineficient for
...
- [#121] for a better compatibility when satidfying dependencies for the
