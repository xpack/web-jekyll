---
title:  xPack xpm v0.11.2 released

summary: "Version **0.11.2** is a maintenance release; it fixes a recursion and improves error reporting."

version: 0.11.2

date: 2021-12-28 14:16:00 +0200
...
- [#125] the changes in v0.11.0 introduced a regression, affecting some
  of the `install --config` use cases; fixed;

### Enhancements

- [#126] in cases when the substitutions fail, for exmple due to missing
  variables, the full stack trace was displayed; the error processing logic
  was improved and normally only the error message is displayed;
...
npm xpm@0.11.2 '/Users/ilg/.nvm/versions/node/v14.16.0/lib/node_modules/xpm'
