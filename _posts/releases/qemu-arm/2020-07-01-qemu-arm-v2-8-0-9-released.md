...
last_updated: 2020-07-01 15:34:00 +0300
...
- [Test xPack OpenOCD on latest platforms](https://travis-ci.org/github/xpack-dev-tools/qemu-arm-xpack/builds/703897230)
...
tested on Raspberry Pi OS 10 (buster) 32/64-bit by manually starting the
blinky test on the emulated STM32F4DISCOVERY board.

```
mkdir -p ~/Downloads
cd ~/Downloads
curl -L --fail  https://github.com/xpack-dev-tools/pre-releases/releases/download/test/xpack-qemu-arm-2.8.0-9-darwin-x64.tar.gz | tar xzf -
curl -L --fail -o f407-disc-blink-tutorial.elf \
...
--image f407-disc-blink-tutorial.elf \
