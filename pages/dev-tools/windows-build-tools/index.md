...
summary: "A binary distribution of Windows Build Tools."
comments: true
...
- make an explicit use of a POSIX shell, which improves the behaviour
...
`sh` packed by **xPack Windows Build Tools** also favour
