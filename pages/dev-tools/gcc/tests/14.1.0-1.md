...
The two overload-new-cpp test cases fail only when gc is used and not static
...
### Failed test sleepy-threads-cv-32

Only the static test cases fail, the other are fine.
...
### Failed test sleepy-threads-cv-64
...
On Windows there are many test cases that fail; to be investigated.
...
This seems to be a problem with LTO, the other test cases are fine.
...
- lto-autoimport-main ✗
  ...
  32 bit pseudo relocation at 00007FF778FA144A out of range, targeting 00007FF9994A136C, yielding the value 00000002204FFF1E.
...
- gc-lto-autoimport-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF7B453294A out of range, targeting 00007FF9994A2580, yielding the value 00000001E4F6FC32.
...
- static-lib-lto-autoimport-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF7702F144A out of range, targeting 00007FF9994A136C, yielding the value 00000002291AFF1E.
...
- static-lib-gc-lto-autoimport-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF62926294A out of range, targeting 00007FF99AFF2580, yielding the value 0000000371D8FC32.
...
Weak symbols seem not supported, probably the LTO test case pass because
the weak symbols are resolved.
...
- lto-throwcatch-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF65D1F14A7 out of range, targeting 00007FF999471654, yielding the value 000000033C2801A9.
...
- gc-lto-throwcatch-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF6177A7D94 out of range, targeting 00007FF9994779B0, yielding the value 0000000381CCFC18.
...
- static-lib-lto-throwcatch-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF6DD6314A7 out of range, targeting 00007FF999471654, yielding the value 00000002BBE401A9.
...
- static-lib-gc-lto-throwcatch-main ✗
  ...
  Mingw-w64 runtime failure:
  32 bit pseudo relocation at 00007FF62AD25164 out of range, targeting 00007FF99AFC8150, yielding the value 00000003702A2FE8.
