...
{% include note.html content="The full static test cases fail, the other are fine.
...
{% include note.html content="The two test cases fail
only when gc is used and not static (to be investigated, see
...
{% include note.html content="This seems to be a problem with LTO, the other test cases are fine." %}
...
the LTO test case pass because the weak symbols are resolved." %}
...
{% include note.html content="This seems to be a problem with LTO,
the other test cases are fine." %}
...
{% include note.html content="Weak symbols seem not supported, probably the LTO test case pass because
