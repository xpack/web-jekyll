...
- `debian:10` - buster - 2019-2022, 2.28, kernel 4.19.0-6 <-- supported by next XBB

### [Ubuntu](https://en.wikipedia.org/wiki/Ubuntu_version_history)

- `ubuntu:10.04` - lucy - 2010-2015, 2.11.1
- `ubuntu:12.04` - precise - 2012-2019, 2.15, kernel **3.2** <--- **XBB v3.3** Intel Linux choice
- `ubuntu:14.04` - trusty - 2014-2022, 2.19, kernel 3.16
- `ubuntu:16.04` - xenial - 2016-2024, **2.23**, kernel 4.4 <--- **XBB v3.3** Arm Linux choice
- `ubuntu:18.04` - bionic - 2018-2028, **2.27**, kernel 4.15 <-- **next XBB** Intel & Arm Linux choice
...
- `registry.access.redhat.com/rhel7` - 2.17, kernel 3.10 <-- still supported by XBB v3.3, but not for long
- `registry.access.redhat.com/ubi8` - 2.28, kernel 5.10 (**next XBB**)

### [CentOS](https://en.wikipedia.org/wiki/CentOS)

- `centos:6` - 2011-2020, 2.12 (no longer supported)
- `centos:7` - 2014-2024, 2.17, kernel 3.10 <--- still supported by XBB v3.3, but not for long
- `centos:8` - 2019-2029, 2.28, kernel 4.18 <-- (**next XBB**)
